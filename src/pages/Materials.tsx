      ...
      <Card>
        <CardHeader className="pb-4">
          <div className="flex flex-col sm:flex-row gap-4 sm:items-center sm:justify-between">
            <CardTitle className="text-lg font-semibold">Lista de Materiais</CardTitle>
              ...
              <Table>
                ...
                <TableBody>
                  {filteredMaterials.map((material) => {
                    const status = material.status as keyof typeof MATERIAL_STATUS;
                    const statusInfo = MATERIAL_STATUS[status] || MATERIAL_STATUS.pendente;
                    
                    return (
                      <TableRow key={material.id} className="cursor-pointer hover:bg-muted/30">
                        ...
                        <TableCell className="text-right">{material.weight_kg.toFixed(2)}</TableCell>
                        <TableCell>
                          <StatusBadge 
